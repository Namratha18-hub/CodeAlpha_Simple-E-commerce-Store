...
function Register() {
  ...
  return (
    <div className="mx-auto flex max-w-md flex-col px-6 py-20">
      ...
      <p className="mt-2 text-muted-foreground">Join Lumen in seconds.</p>

      <form onSubmit={onSubmit} className="mt-8 space-y-4">
        <label className="block">
          <span className="text-sm font-medium">Full name</span>
          <input required className="mt-1.5 h-11 w-full rounded-xl border border-input bg-background px-4 text-sm outline-none focus:border-ring" />
        </label>
        <label className="block">
